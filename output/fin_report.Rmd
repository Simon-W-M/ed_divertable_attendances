...
### `r presentaion_popular_site$chiefcomplaintgrouping[2]`
```{r, echo=FALSE, fig.height=8,fig.width = 16}
grid.arrange(change_plot_ts(attend_pat_cln, presentaion_popular_site$chiefcomplaintgrouping[2], 'attends'),
             change_plot_ts(attend_pat_cln, presentaion_popular_site$chiefcomplaintgrouping[2], 'resource_time'),
             ncol = 2)
```

### `r presentaion_popular_site$chiefcomplaintgrouping[3]`
```{r, echo=FALSE, fig.height=8,fig.width = 16}
grid.arrange(change_plot_ts(attend_pat_cln, presentaion_popular_site$chiefcomplaintgrouping[3], 'attends'),
             change_plot_ts(attend_pat_cln, presentaion_popular_site$chiefcomplaintgrouping[3], 'resource_time'),
             ncol = 2)
```

### `r presentaion_popular_site$chiefcomplaintgrouping[4]`
```{r, echo=FALSE, fig.height=8,fig.width = 16}
grid.arrange(change_plot_ts(attend_pat_cln, presentaion_popular_site$chiefcomplaintgrouping[4], 'attends'),
             change_plot_ts(attend_pat_cln, presentaion_popular_site$chiefcomplaintgrouping[4], 'resource_time'),
             ncol = 2)
```

### `r presentaion_popular_site$chiefcomplaintgrouping[5]`
```{r, echo=FALSE, fig.height=8,fig.width = 16}
grid.arrange(change_plot_ts(attend_pat_cln, presentaion_popular_site$chiefcomplaintgrouping[5], 'attends'),
             change_plot_ts(attend_pat_cln, presentaion_popular_site$chiefcomplaintgrouping[5], 'resource_time'),
             ncol = 2)
```

### `r presentaion_popular_site$chiefcomplaintgrouping[6]`
```{r, echo=FALSE, fig.height=8,fig.width = 16}
grid.arrange(change_plot_ts(attend_pat_cln, presentaion_popular_site$chiefcomplaintgrouping[6], 'attends'),
             change_plot_ts(attend_pat_cln, presentaion_popular_site$chiefcomplaintgrouping[6], 'resource_time'),
             ncol = 2)
```

### `r presentaion_popular_site$chiefcomplaintgrouping[7]`
```{r, echo=FALSE, fig.height=8,fig.width = 16}
grid.arrange(change_plot_ts(attend_pat_cln, presentaion_popular_site$chiefcomplaintgrouping[7], 'attends'),
             change_plot_ts(attend_pat_cln, presentaion_popular_site$chiefcomplaintgrouping[7], 'resource_time'),
             ncol = 2)
```

### `r presentaion_popular_site$chiefcomplaintgrouping[8]`
```{r, echo=FALSE, fig.height=8,fig.width = 16}
grid.arrange(change_plot_ts(attend_pat_cln, presentaion_popular_site$chiefcomplaintgrouping[8], 'attends'),
             change_plot_ts(attend_pat_cln, presentaion_popular_site$chiefcomplaintgrouping[8], 'resource_time'),
             ncol = 2)
```

### `r presentaion_popular_site$chiefcomplaintgrouping[9]`
```{r, echo=FALSE, fig.height=8,fig.width = 16}
grid.arrange(change_plot_ts(attend_pat_cln, presentaion_popular_site$chiefcomplaintgrouping[9], 'attends'),
             change_plot_ts(attend_pat_cln, presentaion_popular_site$chiefcomplaintgrouping[9], 'resource_time'),
             ncol = 2)
```

### `r presentaion_popular_site$chiefcomplaintgrouping[10]`
```{r, echo=FALSE, fig.height=8,fig.width = 16}
grid.arrange(change_plot_ts(attend_pat_cln, presentaion_popular_site$chiefcomplaintgrouping[10], 'attends'),
             change_plot_ts(attend_pat_cln, presentaion_popular_site$chiefcomplaintgrouping[10], 'resource_time'),
             ncol = 2)
```

### `r presentaion_popular_site$chiefcomplaintgrouping[11]`
```{r, echo=FALSE, fig.height=8,fig.width = 16}
grid.arrange(change_plot_ts(attend_pat_cln, presentaion_popular_site$chiefcomplaintgrouping[11], 'attends'),
             change_plot_ts(attend_pat_cln, presentaion_popular_site$chiefcomplaintgrouping[11], 'resource_time'),
             ncol = 2)
```

### `r presentaion_popular_site$chiefcomplaintgrouping[12]`
```{r, echo=FALSE, fig.height=8,fig.width = 16}
grid.arrange(change_plot_ts(attend_pat_cln, presentaion_popular_site$chiefcomplaintgrouping[12], 'attends'),
             change_plot_ts(attend_pat_cln, presentaion_popular_site$chiefcomplaintgrouping[12], 'resource_time'),
             ncol = 2)
```

### `r presentaion_popular_site$chiefcomplaintgrouping[13]`
```{r, echo=FALSE, fig.height=8,fig.width = 16}
grid.arrange(change_plot_ts(attend_pat_cln, presentaion_popular_site$chiefcomplaintgrouping[13], 'attends'),
             change_plot_ts(attend_pat_cln, presentaion_popular_site$chiefcomplaintgrouping[13], 'resource_time'),
             ncol = 2)
```

### `r presentaion_popular_site$chiefcomplaintgrouping[14]`
```{r, echo=FALSE, fig.height=8,fig.width = 16}
grid.arrange(change_plot_ts(attend_pat_cln, presentaion_popular_site$chiefcomplaintgrouping[14], 'attends'),
             change_plot_ts(attend_pat_cln, presentaion_popular_site$chiefcomplaintgrouping[14], 'resource_time'),
             ncol = 2)
```
...
a <- change_plot(
 ...
 'total', '1',
 site,
  'Percentage change of pre covid type 1 walk in admissions',
 'perc_change_c')
...
b <- change_plot(
 ...
 'total', '1',
 site,
  'Percentage change of pre covid type 1 walk in time (total - wait)',
 'perc_change_t_c')
...
a <- change_plot(
  attend_pat_cln,
  presentaion_popular_site$chiefcomplaintgrouping[7],
 'total', '1',
 site,
  'Percentage change of pre covid type 1 walk in admissions',
 'perc_change_c')
...
a <- change_plot(
  attend_pat_cln,
  presentaion_popular_site$chiefcomplaintgrouping[8],
 'total', '1',
 site,
  'Percentage change of pre covid type 1 walk in admissions',
 'perc_change_c')
...
a <- change_plot(
  attend_pat_cln,
  presentaion_popular_site$chiefcomplaintgrouping[9],
 'total', '1',
 site,
  'Percentage change of pre covid type 1 walk in admissions',
 'perc_change_c')
...
a <- change_plot(
  attend_pat_cln,
  presentaion_popular_site$chiefcomplaintgrouping[10],
 'total', '1',
 site,
  'Percentage change of pre covid type 1 walk in admissions',
 'perc_change_c')
...
a <- change_plot(
  attend_pat_cln,
  presentaion_popular_site$chiefcomplaintgrouping[11],
 'total', '1',
 site,
  'Percentage change of pre covid type 1 walk in admissions',
 'perc_change_c')
...
a <- change_plot(
  attend_pat_cln,
  presentaion_popular_site$chiefcomplaintgrouping[12],
 'total', '1',
 site,
  'Percentage change of pre covid type 1 walk in admissions',
 'perc_change_c')
...
a <- change_plot(
  attend_pat_cln,
  presentaion_popular_site$chiefcomplaintgrouping[13],
 'total', '1',
 site,
  'Percentage change of pre covid type 1 walk in admissions',
 'perc_change_c')
...
a <- change_plot(
  attend_pat_cln,
  presentaion_popular_site$chiefcomplaintgrouping[14],
 'total', '1',
 site,
  'Percentage change of pre covid type 1 walk in admissions',
 'perc_change_c')
...
```{r echo=FALSE, warning = FALSE, results='hide',fig.height=6,fig.width = 12,message=FALSE, warnings = FALSE}
...
This will help us identify if there are any trend in our **divertible attendances**, to see if this co hort is increasing,  decreasing or static.  
...
```{r echo=FALSE, warning = FALSE, results='hide',fig.height=9, fig.width = 12,message=FALSE, warnings = FALSE}
CG_SPC
...
It is hoped that this report helps to understand the pressure within departments and what are the causes of pressure.  The flow of patients due to the increased times in ward is no doubt contributing to crowding, yet actual numbers of attendances are not always significantly increased.

The cluster analysis may open some possibilities and understanding to some sets of patients that may b e able to be diverted away from emergency departments.

Additional analysis around pathways, flow, demand and capacity would also assist in understanding where bottlenecks may be occurring and what alternatives may be available to reduce time in department.

This would have a impact on throughput as well as being benefitiacial to quality and patient outcomes.
